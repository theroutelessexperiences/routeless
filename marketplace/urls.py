...
urlpatterns = [
    ...
    path('host/<str:username>/', views.host_profile_view, name='host_profile'),
    path('host-apply/details/', views.host_apply_details, name='host_apply_details'),
    path('host-apply/verification/', views.host_apply_verification, name='host_apply_verification'),
    path('host-apply/business/', views.host_apply_business, name='host_apply_business'),
    path('host-apply/declaration/', views.host_apply_declaration, name='host_apply_declaration'),
    path('host-apply/status/', views.host_apply_status, name='host_apply_status'),
